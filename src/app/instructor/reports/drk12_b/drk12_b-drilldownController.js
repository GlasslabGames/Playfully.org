angular.module( 'instructor.reports')
    .controller('Drk12Drilldown', function($scope, $state, $window, $stateParams, myGames, defaultGame, gameReports, ReportsService, Drk12Service, usersData) {
        ...
        var magicDataIdBackings = {
            4990: ["Sally also was takjing a course on nutrition, so that might have influenced her."],
            ...
            4864: ["We know Anne is an AUTHORITY because Anne was President of the Engineering Society for ten years.",
                   "All our EXPERT engineers agree with Anne that we should make maintennce our top priority."],
            ...
            4874: ["In our last community kareoke night - people agreed there was NO OTHER INTERPRETATION.",
            ...
            4845: ["Ms. Tam won ten different awards for her knowledge of on-the-job training.",
            ...
            4846: ["JR is a five time world champion in security tactics competitions.",
                   "Second and third place winers of the World Security Championships agree with JR."],
            ...
            4852: ["It will be impossible for Lucas to interact with people or robots on Mars once he's on Earth.",
                   "Our space law expert says all of the NEGATIVE CONSEQUECES are minor."],
            ...
            4511: ["His toothpick collection was rated number one in Brackett City.",
                   "No one on Mars reall knows who he is."],
