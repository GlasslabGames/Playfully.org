...
.controller('AppCtrl',
  function($scope, $rootScope, $state, $log, $modal, $timeout, $window, $location,
    ...
    if (!$rootScope.allGames) {
      $rootScope.allGames = [{"gameId":"AA-1","enabled":true,"shortName":"Argubot Academy EDU","longName":"Mars Generation One: Argubot Academy EDU","description":"Mars Generation One: Argubot Academy EDU is an engaging futuristic adventure game for iOS tablets. Aligned to the Common Core State Standards, the game brings STEM content into the English Language Arts classroom, and helps middle schoolers develop persuasion and reasoning skills. In Argubot Academy EDU, players take on the persona of a new student at Argubot Academy, the cityâ€™s middle school. There, each player will have to make very adult decisions about the building and governance of the city, for example: What type of food should the citizens cultivate? Players have to build sound arguments for every choice they make â€“ but in this city on Mars, people settle their differences by equipping their robot assistants, called argubots, with claims and evidence, culminating in robot battles of the wits!","settings":{},"license":{"type":"loginType","loginType":["glasslabv2","edmodo"],"valid":true,"message":{"invalid":"Coming Soon!"}},"thumbnail":{"small":"assets/thumb-game-AA-1.png","large":"assets/thumb-game-AA-1.png"},"developer":{"id":"GL","name":"GlassLab, Inc.","logo":{"small":"assets/glasslab-logo.png","large":"assets/glasslab-logo-2x.png"}}},{"gameId":"AW-1","enabled":true,"maintenance":{"message":"Coming Soon!"},"shortName":"Argument Wars","longName":"Argument Wars","description":"Try out your persuasive abilities by arguing a real Supreme Court case. The other lawyer is your competition. Whoever uses the strongest arguments wins!","settings":{},"license":{"type":"loginType","loginType":["icivics"],"valid":false,"message":{"invalid":"Coming Soon!"}},"thumbnail":{"small":"assets/thumb-game-AW-1.png","large":"assets/thumb-game-AW-1.png"},"play":{"type":"page","page":{"title":"Argument Wars","embed":"https://staging.icivics.org/sites/default/files/games/ArgumentWars_v1.4.2-GL-R5/Main.swf","size":{"width":940,"height":640}}},"developer":{"id":"IC","name":"iCivics","logo":{"small":"assets/icivics-logo.png","large":"assets/icivics-logo-2x.png"}}},{"gameId":"SC","enabled":true,"maintenance":{"message":"Coming Soon!"},"shortName":"SimCityEdu","longName":"SimCityEDU: Pollution Challenge!","description":"SimCityEDU: Pollution Challenge!","settings":{"missionProgressLock":false},"license":{"type":"loginType","loginType":["clever"],"valid":false,"message":{"invalid":"Coming Soon!"}},"thumbnail":{"small":"assets/thumb-game-SC.png","large":"assets/thumb-game-SC.png"},"play":{"type":"missions"},"developer":{"id":"GL","name":"GlassLab, Inc.","logo":{"small":"assets/glasslab-logo.png","large":"assets/glasslab-logo-2x.png"}}}];
