      ...
      $scope.platformFilter = function() {
         return function(game) {
             ...
             if ($scope.platform.selected === 'Chromebook') {
                 return game.platform.type === 'Browser/Flash' || game.platform.type === 'Browser';
             }
             if ($scope.platform.selected === 'PC/Mac') {
                 return game.platform.type === 'Browser/Flash' || game.platform.type === 'Browser' || game.platform.type === 'PC & Mac';
             }
